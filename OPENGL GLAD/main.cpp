...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("resources/shaders/vshader.vs", "resources/shaders/fshader.fs");
    Shader lampShader("resources/shaders/basicshader.vs", "resources/shaders/basicshader.fs");
